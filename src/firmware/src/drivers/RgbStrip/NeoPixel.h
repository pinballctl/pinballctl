#ifndef PINBALLCTL_RGB_STRIP_NEOPIXEL_H
#define PINBALLCTL_RGB_STRIP_NEOPIXEL_H

#include <Arduino.h>
#include <vector>

class RgbStripNeoPixel {
 public:
  static constexpr const char* kFunction = "RGB Strip";
  static constexpr const char* kDriver = "NeoPixel";
...
#endif  // PINBALLCTL_RGB_STRIP_NEOPIXEL_H
